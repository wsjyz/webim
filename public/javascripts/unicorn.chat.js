...
$(document).ready(function(){
	...
	$('.chat-message button').click(function(){
		...
		if(input.val() != ''){
			add_message('You','/images/av1.jpg',input.val(),true);
		} else {
	...
	message_box_input.keypress(function(e){
		...
		if(e.which == 13) {	
			if($(this).val() != ''){
				add_message('You','/images/av1.jpg',$(this).val(),true);
			} else {
				$('.input-box').addClass('has-error');
			}		
		}
	...
	setTimeout(function(){
		add_message('Neytiri','/images/av2.jpg','I have a problem. My computer not work!')
	},'1000');
	setTimeout(function(){
		add_message('Cartoon Man','/images/av3.jpg','Turn off and turn on your computer then see result.')
	},'5000');
	setTimeout(function(){
